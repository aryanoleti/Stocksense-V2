...
function TickerCopy() {
  return (
    <span className="mx-6 whitespace-nowrap text-[20px] text-[#1F2937] dark:text-[#E5E9F0] sm:text-[24px]">
...
export function MarqueeStrip() {
  return (
    <div className="overflow-hidden border-y border-[#DBEAFE] bg-white py-6 dark:border-white/10 dark:bg-[#0A0C14]">
      <div
