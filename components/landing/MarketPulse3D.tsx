...
export function MarketPulse3D() {
  ...
  return (
    <section id="market-pulse" className="relative overflow-hidden bg-[var(--color-brand-950)]">
      {/* Single saturated brand moment — restrained glows, no gradient soup */}
      <div className="absolute left-1/2 top-0 h-px w-[min(1200px,90%)] -translate-x-1/2 bg-gradient-to-r from-transparent via-[var(--color-brand-400)]/40 to-transparent" />
      <div className="pointer-events-none absolute -left-40 top-1/3 h-[420px] w-[420px] rounded-full bg-[var(--color-brand-500)]/10 blur-3xl" />
