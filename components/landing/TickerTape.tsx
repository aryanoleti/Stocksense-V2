...
export function TickerTape() {
  ...
  return (
    <div className="marquee-hover relative overflow-hidden border-y border-white/10 bg-white/[0.03] py-3 backdrop-blur-sm">
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-gradient-to-r from-[var(--color-brand-950)] to-transparent" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-[var(--color-brand-950)] to-transparent" />
