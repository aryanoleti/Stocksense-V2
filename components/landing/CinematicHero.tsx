...
export function CinematicHero() {
  ...
  return (
    <section ref={sectionRef} className="relative isolate min-h-[108vh]">
      ...
      <div
        ref={orb1Ref}
        className="absolute -top-32 left-[8%] -z-10 h-[440px] w-[440px] rounded-full bg-[var(--color-brand-400)]/14 blur-3xl"
      />
      <div
        ref={orb2Ref}
        className="absolute top-[30%] right-[4%] -z-10 h-[380px] w-[380px] rounded-full bg-[var(--color-brand-300)]/10 blur-3xl"
      />
        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.08fr_1fr] lg:gap-16">
          <div ref={copyRef} style={{ willChange: "transform, opacity" }}>
            ...
            >
              ...
              <MarketingButton href="/ask-ai" variant="ghost" size="lg" className="text-white hover:bg-white/10">
